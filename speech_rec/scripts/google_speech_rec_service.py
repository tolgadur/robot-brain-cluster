...
File name: google_speech_rec_service.py
...
class SpeechRecService:
    ...
    def translate_speech(self, request=None):
        """
        ...
        print("ASDASHDKAJSHDAJKH")
        if request.language_code == 'en-EN':
            language_code = 'en-US'
        else:
            language_code = request.language_code  # a BCP-47 language tag
